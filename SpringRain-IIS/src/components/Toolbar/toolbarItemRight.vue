<template>
  <div class="q-gutter-sm row items-center no-wrap q-electron-drag--exception">
    <q-input  dense outlined v-model="search" style="min-width: 30px" input-class="text-right" class="q-ml-md">
        ...
        <q-menu>
          <div class="row no-wrap q-pa-md">
            ...
            <div class="column items-center">
              ...
              <div class="text-subtitle1 q-mt-md q-mb-xs">CloudWoR</div>
  ...
  methods: {
    ...
    minimize () {
      if (process.env.MODE === 'electron') {
        ipcRenderer.invoke('browserWindow', 'minimize')
      }
    },

    maximize () {
      if (process.env.MODE === 'electron') {
        ipcRenderer.invoke('browserWindow', 'maximize')
      }
    },
